...
// difficulty tier, and language. Usage: node benchmark/analyze.mjs <resultsDir...>
import { readFileSync, existsSync } from 'node:fs';
import { join, resolve } from 'node:path';

const dirs = process.argv.slice(2).map((d) => resolve(d));
if (!dirs.length) { console.error('usage: node benchmark/analyze.mjs <resultsDir...>'); process.exit(2); }
